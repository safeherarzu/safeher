...
class AppStrings {
  static const Map<String, Map<String, String>> _localized = {
    'tr': {
      ...
      'login': 'Giriş Yap',
      'register': 'Kayıt Ol',
      'forgotPassword': 'Şifre Yenileme',
      'email': 'E-posta',
      'password': 'Şifre',
      'passwordAgain': 'Şifre (Tekrar)',
      'rememberMe': 'Beni Hatırla',
      'sendResetLink': 'Güvenli Bağlantı Gönder',
      'noAccountRegister': 'Hesabın yok mu? Kayıt ol',
      'forgotPasswordShort': 'Şifremi unuttum',
      'backToLogin': 'Girişe dön',
      'resetMailSent':
          'Şifre yenileme bağlantısı e-posta adresine gönderildi. Gelen kutunu ve spam klasörünü kontrol et.',
