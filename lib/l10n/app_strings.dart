...
class AppStrings {
  static const Map<String, Map<String, String>> _localized = {
    'tr': {
      ...
      'nearbyBuses': 'Yakındaki Otobüsler',
      'nearbyHospitals': 'Yakındaki Hastaneler',
      'nearbyPharmacies': 'Yakındaki Eczaneler',
      'searchingBuses': 'Duraklar aranıyor…',
      'searchingHospitals': 'Hastaneler aranıyor…',
      'searchingPharmacies': 'Eczaneler aranıyor…',
    ...
    'en': {
      ...
      'nearbyBuses': 'Nearby bus stops',
      'nearbyHospitals': 'Nearby hospitals',
      'nearbyPharmacies': 'Nearby pharmacies',
      'searchingBuses': 'Searching stops…',
      'searchingHospitals': 'Searching hospitals…',
